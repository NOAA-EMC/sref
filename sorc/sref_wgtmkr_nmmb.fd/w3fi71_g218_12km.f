...
C
     ...
     & -104000,    121,121,64, 53942, -10984, 0, 0, 0/
...
c     DATA  GRD93 / 0, 255,203,179,401,  45346, -171678, 136,   63000,
c    & -150000,   088,075,64, 0, 0, 0, 0, 0/
...
c     DATA  GRD94 / 0, 255,203,340,563,  13246, -143473, 136,   50000,
c    & -111000,    108,103,64, 0, 0, 0, 0, 0/ 
C
C  B-grids
C  89=CONUS DGEX
C  93=Alaska DGEX
...
C  99=Parent
C
      DATA  GRD89 / 0, 255,205,421,302, 19757, -125034, 136,   40000,
     & -98000,    126,108,64, 50073, -56203, 0, 0, 0/
      DATA  GRD93 / 0, 255,205,325,231, 44127, -185328, 136,   61000,
     & -157000,    126,108,64, 64759, -103888, 0, 0, 0/
      DATA  GRD94 / 0, 255,205,595,625, 34921, -161663, 136,   54000,
     & -106000,    063,054,64, 83771, -151721, 0, 0, 0/
      DATA  GRD95 / 0, 255,205,401,325,  17609, -76327, 136,    54000,
     & -106000 ,  032,027,64, 18840, -61261, 0, 0, 0/
...
C
     ...
     &  12000, 12000, 0, 64, 0, 33000, 45000, 0, 0/ 
      DATA  GRD139/ 0, 255, 3, 66,46,  18033, -161187,  8,   -157500,
     &  12000, 12000, 0, 64, 0, 19000, 21000, 0, 0/
      DATA  GRD140/ 0, 255, 3, 200,164,  52945, -166534,  8,   -148600,
     &  12000, 12000, 0, 64, 0, 57000, 63000, 0, 0/ 
      DATA  GRD149/ 0, 255, 3, 1330,799,  21756, -120694,  8,   -97000,
     &  4000, 4000, 0, 64, 0, 33000, 45000, 0, 0/ 
      DATA  GRD150/ 0, 255, 0, 401,201,   5000, -100000, 128,   25000,
     &  -60000,   100, 100, 64, 0, 0, 0, 0, 0/
c4km
c     DATA  GRD151/ 0, 255, 3, 331,368,  26732, -127602,   8, -121000,
c    &   4000,  4000, 0, 64, 0, 33500, 33500, 0, 0/
     ...
     &  12679, 12679,   0, 64, 0, 0, 0, 0, 0/
      DATA  GRD152/ 0, 255, 5, 1381,1185,-10000, 215000,   8,  -110000,
     &   33812, 33812,   0, 64, 0, 0, 0, 0, 0/
...
C
c     DATA  GRD180/ 0, 255, 3, 148,179,  30000,  -86000,   8,  -77000,
c    &  12000, 12000, 0, 64, 0, 38000, 38000, 0, 0/
c     DATA  GRD181/ 0, 255, 3, 269,183,  30000, -113000,   8,  -94000,
c    &  12000, 12000, 0, 64, 0, 40000, 40000, 0, 0/
c     DATA  GRD182/ 0, 255, 3, 275,147,  23000, -110000,   8,  -96000,
c    &  12000, 12000, 0, 64, 0, 31000, 31000, 0, 0/
Cdgex
     ...
     & -106000,    126, 108, 64, 44539, 14802, 0, 0, 0/
C SREF 16km domain
      DATA  GRD191/ 0, 255,205,716,627,  -7527, -144119, 136,   54000,
     & -106000,    168, 144, 64, 44532, 14855, 0, 0, 0/
C SREF 20km domain
c     DATA  GRD191/ 0, 255,205,572,501,  -7424, -144117, 136,   54000,
c    & -106000,    210, 180, 64, 44591, 14737, 0, 0, 0/
c SREF 25km domain
c     DATA  GRD191/ 0, 255,205,458,401,  -7437, -144130, 136,   54000,
c    & -106000,    262, 225, 64, 44573, 14741, 0, 0, 0/
      DATA  GRD192 / 0, 255,203,237,387, -3441, -148799, 136,   50000,
     & -111000,    225,207,64, 0, 0, 0, 0, 0/
c     DATA  GRD194 / 0, 255,203, 71,115, 16432, -162205, 136,   20250,
c    & -157350,     67, 66,64, 0, 0, 0, 0, 0/
C
C  grid 194: new 3 km P.Rico grid for expanded NAM nest
C
