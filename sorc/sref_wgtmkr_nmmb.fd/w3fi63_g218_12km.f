          ...
          IF (IAND(KPDS(4),64).NE.0) THEN
              IF (KPDS(3).NE.255) THEN
                  ...
                  IF (KPDS(1).EQ.7) THEN
                      ...
                      ELSE IF (KPDS(3).GE.150.AND.KPDS(3).LE.179) THEN
...
C                       ----- U.S GRID 87     - MAP SIZE 5022
                  J     = 5022
                  GO TO 800
              ELSE IF (KPDS(3).EQ.89) THEN
C                       ----- U.S GRID 89     - MAP SIZE 5022
                  J     = 127142
                  GO TO 800
...
C                 ----- U.S. GRID 126 - MAP SIZE 72960
                  J     = 205062
                  GO TO 800
              ELSE IF (KPDS(3).GE.152.AND.KPDS(3).LE.172) THEN
...
C                 ----- U.S. GRID 150 - MAP SIZE 49051
                  ...
                  GO TO 800
              ELSE IF (KPDS(3).EQ.151) THEN
C                 ----- U.S. GRID 151 - MAP SIZE 49051
                  J     = 205062
                  GO TO 800
              ELSE IF (KPDS(3).EQ.152) THEN
C                 ----- U.S. GRID 151 - MAP SIZE 49051
                  J     = 1636485
                  GO TO 800
...
C                 ----- U.S GRID 190  - MAP SIZE 796590
                  J     = 796590
                  GO TO 800
              ELSE IF (KPDS(3).EQ.191) THEN
C 16km SREF
C                 ----- U.S GRID 190  - MAP SIZE 716x627
                  J     = 448932
C 20km SREF
C                 ----- U.S GRID 190  - MAP SIZE 572x501
C                 J     = 286572
C 25km SREF
C                 ----- U.S GRID 190  - MAP SIZE 458x401
c                 J     = 183658
                  GO TO 800
      ...
      ELSE IF (KPDS(1).EQ.7) THEN
          ...
          ELSE IF (KPDS(3).GE.67.AND.KPDS(3).LE.77) THEN
              IF (I.NE.J) THEN
                  RETURN
              END IF
          ELSE IF (KPDS(3).GE.83.AND.KPDS(3).LE.86) THEN
              IF (I.NE.J) THEN
                  RETURN
              END IF
          ELSE IF (KPDS(3).EQ.87) THEN
          ...
          ELSE IF (KPDS(3).EQ.132) THEN
              IF (I.NE.J) THEN
                  RETURN
              END IF
          ELSE IF (KPDS(3).GE.138.AND.KPDS(3).GE.140) THEN
              IF (I.NE.J) THEN
                  RETURN
              END IF
          ELSE IF (KPDS(3).EQ.149) THEN
