...
((((model_config_rec%ts_buf_size)-(1)+1))*(((model_config_rec%max_ts_locs)-(1)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",17307,&
...
((((model_config_rec%ts_buf_size)-(1)+1))*(((model_config_rec%max_ts_locs)-(1)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",17478,&
...
((((model_config_rec%ts_buf_size)-(1)+1))*(((model_config_rec%max_ts_locs)-(1)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",17706,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",17982,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",18039,&
...
((((model_config_rec%ts_buf_size)-(1)+1))*(((model_config_rec%max_ts_locs)-(1)+1))*(((em32)-(sm32)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",18105,&
...
((((model_config_rec%ts_buf_size)-(1)+1))*(((model_config_rec%max_ts_locs)-(1)+1))*(((em32)-(sm32)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",18162,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",18210,&
...
((((model_config_rec%ts_buf_size)-(1)+1))*(((model_config_rec%max_ts_locs)-(1)+1))*(((em32)-(sm32)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",18219,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",18267,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",18324,&
...
((((em31)-(sm31)+1))*(((model_config_rec%num_urban_hi)-(1)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",19092,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",19142,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",19201,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",19260,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",19319,&
...
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",19387,&
...
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",19446,&
...
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",19564,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",19614,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",19673,&
...
((((em31)-(sm31)+1))*(((4)-(1)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",19682,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",19732,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",19850,&
...
((((em31)-(sm31)+1))*(((4)-(1)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",19859,&
...
((((em31)-(sm31)+1))*(((model_config_rec%num_soil_layers)-(1)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",19918,&
...
((((em31)-(sm31)+1))*(((model_config_rec%num_soil_layers)-(1)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",19977,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",20086,&
...
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",20095,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",20145,&
...
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",20154,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",20263,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",20322,&
...
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",20331,&
...
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",20390,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",20499,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",20558,&
...
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",20567,&
...
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",21606,&
...
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",21665,&
...
((((model_config_rec%dfi_time_dim)-(1)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",21724,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",21850,&
...
((((em31)-(sm31)+1))*(((em32)-(sm32)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",21859,&
...
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",21918,&
...
((((em31)-(sm31)+1))*(((em32)-(sm32)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",21977,&
...
((((em31)-(sm31)+1))*(((em32)-(sm32)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",22036,&
...
((((em31)-(sm31)+1))*(((em32)-(sm32)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",22095,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",22145,&
...
((((em31)-(sm31)+1))*(((em32)-(sm32)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",22154,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",22204,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",22263,&
...
((((em31)-(sm31)+1))*(((em32)-(sm32)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",22331,&
...
((((em31)-(sm31)+1))*(((em32)-(sm32)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",22390,&
...
((((em31)-(sm31)+1))*(((em32)-(sm32)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",22449,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",22499,&
...
((((em31)-(sm31)+1))*(((em32)-(sm32)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",22508,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",22558,&
...
((((em31)-(sm31)+1))*(((em32)-(sm32)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",22567,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",22617,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",22676,&
...
((((em31)-(sm31)+1))*(((em32)-(sm32)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",22685,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",22735,&
...
((((em31)-(sm31)+1))*(((em32)-(sm32)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",22744,&
...
((((em31)-(sm31)+1))*(((model_config_rec%num_soil_layers)-(1)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",22803,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",22853,&
...
((((em31)-(sm31)+1))*(((model_config_rec%num_soil_layers)-(1)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",22862,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",22912,&
...
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",22921,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",22971,&
