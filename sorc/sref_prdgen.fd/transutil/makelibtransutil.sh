...
#              archive libraries.
#  11/01/2012  rename the gem lib to transutil to avoid the confusion with
#              gempak lib for WCOSS.
###############################################################
...
EOF
#
#     Update 4-byte version of libtransutil_4.a
#
export LIB="libtransutil_4.a"
export FFLAGS=" -O3 -g"
export CFLAGS=" -O3 -DLINUX"
make -f make.libgem
#
#     Update 8-byte version of libtransutil_8.a
#
#export LIB="../../libtransutil_8.a"
