...
# Self-designed NDAS grid covering SREF nmmb domain
grid='255 5 535 460 -12000 -145000 8 -110000 33812 33812 0 64 0 0 0 0 0'
...
case $HH00 in
 ...
 03) ndas1=$COMINnam/nam.$PDY03/nam.t${HH03}z.bgdawp00.tm03
     ndas2=$COMINnam/nam.$PDYb3/nam.t${HHb3}z.bgdawp03.tm00;;
 06) ndas1=$COMINnam/nam.$PDY00/nam.t${HH00}z.bgdawp00.tm00
     ndas2=$COMINnam/nam.$PDYb6/nam.t${HHb6}z.bgdawp06.tm00;;
 09) ndas1=$COMINnam/nam.$PDY03/nam.t${HH03}z.bgdawp00.tm03
     ndas2=$COMINnam/nam.$PDYb3/nam.t${HHb3}z.bgdawp03.tm00;;
 12) ndas1=$COMINnam/nam.$PDY00/nam.t${HH00}z.bgdawp00.tm00
     ndas2=$COMINnam/nam.$PDYb6/nam.t${HHb6}z.bgdawp06.tm00;;
 15) ndas1=$COMINnam/nam.$PDY03/nam.t${HH03}z.bgdawp00.tm03
     ndas2=$COMINnam/nam.$PDYb3/nam.t${HHb3}z.bgdawp03.tm00;;
 18) ndas1=$COMINnam/nam.$PDY00/nam.t${HH00}z.bgdawp00.tm00
     ndas2=$COMINnam/nam.$PDYb6/nam.t${HHb6}z.bgdawp06.tm00;;
 21) ndas1=$COMINnam/nam.$PDY03/nam.t${HH03}z.bgdawp00.tm03
     ndas2=$COMINnam/nam.$PDYb3/nam.t${HHb3}z.bgdawp03.tm00;;
esac

if [ -s $ndas1 ]; then
  $CNVGRIB -g21 $ndas1 bgd2nmb.grib1
  ${COPYGB} -g"$grid" -i1,1 -x bgd2nmb.grib1 bgd2nmb.${DATE}
elif [ -s $ndas2 ]; then
  $CNVGRIB -g21 $ndas2 bgd2nmb.grib1
  ${COPYGB} -g"$grid" -i1,1 -x bgd2nmb.grib1 bgd2nmb.${DATE}
else
  set +x
  echo "**********************************************************"
