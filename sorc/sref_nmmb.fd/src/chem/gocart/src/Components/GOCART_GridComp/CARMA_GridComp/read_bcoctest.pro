  openr, lun, 'bcoctest.txt', /get_lun
...
;  BCOC
   ...
   massdens[*,*,1] = pc[*,*,1]*rmass[*,*,1]
   massdens[*,*,2] = pc[*,*,2]*rmass[*,*,2]
   massdens[*,*,3] = pc[*,*,3]

   mass   = total(massdens[*,*,0],1) + total(massdens[*,*,1],1) + total(massdens[*,*,2],1)
   massbc = total(massdens[*,*,0],1) + total(massdens[*,*,3],1) 
   massoc = total(massdens[*,*,1],1) + total(massdens[*,*,2],1) - total(massdens[*,*,3],1) 
