...
! In the current SREF.v6.1.2 (nmb_n2/p2) GFS mp still uses old 9 but not new 99,
! so this is set back to 9 (in the standard released version, it uses 99
! instead. (Jun Du, 1/23/2014)
	   IF(imp_physics.eq.9)THEN ! use rain rate for visibility
