...
!
     ...
     &,  QMAX=30.e-3             & !--- Upper limit for moisture fields
...
!
      DO L=1,LML
        ...
        QMID(I,L+LVLIJ)=MAX(EPSQ, MIN(Q(I,J,L), QMAX ) )
!--- Note that rain is ignored, only effects from cloud water and 
!    ice (cloud ice + snow) are considered
        QWMID(I,L+LVLIJ)=MIN(QCW(I,J,L), QMAX)
        QIMID(I,L+LVLIJ)=MIN(QICE(I,J,L), QMAX)
      ENDDO
!***
...
!---TEMP. INDICES FOR E1,SOURCE
      ...
      FXO(I,K)=AMAX1(H_1, VTMP3(I,K)-9.)
      DT(I,K)=AMAX1(H_0, TEMP(I,K)-TEN*VTMP3(I,K) )
...
!---TEMP. INDICES FOR E2 (KP=1 LAYER NOT USED IN FLUX CALCULATIONS)
      ...
      FXOE2(I,K)=AMAX1(H_1, VTMP3(I,K)-9.)
      DTE2(I,K)=AMAX1(H_0, T(I,K+1)-TEN*VTMP3(I,K) )
103   CONTINUE
