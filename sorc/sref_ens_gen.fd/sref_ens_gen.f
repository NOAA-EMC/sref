...
c 2014-05-20: Jun Du and Binbin: Added kpds(17) to distinguish ave and acc ppt
c
c$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
C$$$
C
...
201    format(<timestep>(i3))
       write(*,*) 'IENS',IENS,' GRIBID',GRIBID,' KM',KM,' TIMESTEP', 
     &timestep,'INTERVAL',interval,'nfhr',nfhr
c      print *, 'FNN(1)',fnn(1),' FNN(timestep)',fnn(timestep)
       print *, 'FNN=', (fnn(i),i=1,timestep)
...
!  safer to try read(itime,*) fhr
        if(itime.lt.100) then
         ...
         fname2=trim(fhead(irun)) // '.f' // trim(hr)
         print*,'Opening ',fname2
         call baopenr(iunit,fname2,ierr)
        endif
...
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
     ...
     +                      kpds(7).eq.12900) then
               ...
               if(kpds(5).eq.61.and.kpds(6).eq.1
     +            .and.kpds(17).eq.3) goto 555 !use accum not averaged precip
...
c reprocess precip data based on different models and fcst hours when necessary
     ...
     +                      kpds(7).eq.12900) then
               ...
               if(kpds(5).eq.61.and.kpds(6).eq.1.and
     +                 .kpds(17).eq.3)goto 555 
