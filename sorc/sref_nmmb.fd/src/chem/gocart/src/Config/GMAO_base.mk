...
INC_PSAS = $(ESMAINC)/psas
LIB_PSAS = $(ESMALIB)/libpsas.a
...
INC_GEOS_CHEM    = $(INC_CHEM) $(INC_CHEM_GOCART) $(INC_CHEM_PCHEM) $(INC_CHEM_GMI) $(INC_CHEM_STRAT)
...
INC_GEOS_PHYS    = $(ESMAINC)/GEOSphysics_GridComp $(INC_CHEM_GOCART) $(INC_CHEM_PCHEM) $(INC_CHEM_GMI) $(INC_CHEM_STRAT) $(INC_GEOS_GWD) $(INC_GEOS_MOIST) $(INC_GEOS_RAD) $(INC_GEOS_SURF) $(INC_GEOS_TURB)
...
INC_GEOS_SDYN    = $(ESMAINC)/GEOSsuperdyn_GridComp $(INC_GEOS_FV) $(INC_GEOS_FV3) $(INC_GEOS_ARIES) $(INC_GEOS_DATMO)
...
INC_GEOS_SICE    = $(ESMAINC)/GEOSseaice_GridComp $(INC_GEOS_DATASICE)
