...
cp conf/configure.nems.Wcoss_cray.intel_ESMF_630r_nmm conf/configure.nems
gmake clean
cd ..
...
rm -f *.o
make -f makefile_cluster_wcoss_cray clean
cd ..
...
rm -f *.o *.mod
make -f makefile_REG_wcoss_cray clean
make -f makefile_DS_wcoss_cray clean
cd ../
...
rm -f *.o
make -f makefile_em_wcoss_cray clean
make -f makefile_nmmb_wcoss_cray clean
rm -f *.o
cd ..
