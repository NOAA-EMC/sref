...
#                  $PGMERR
#
#     scratch    : ${workdir}/postgp.inp.sig
#                  ${workdir}/postgp.inp.flx
#                  ${workdir}/postgp.out.pgb
#
# Remarks:
#
#   Condition codes
...
[[ $(echo $PGMOUT|cut -c1) = '&' ]]&&a=''||a='>'
export REDOUT=${REDOUT:-'1>'$a}
[[ $(echo $PGMERR|cut -c1) = '&' ]]&&a=''||a='>'
...
eval $POSTGPEXEC <postgp.inp.nml$$ $REDOUT$PGMOUT $REDERR$PGMERR

export ERR=$?
export err=$ERR
$ERRSCRIPT||exit 2
rm postgp.inp.nml$$ postgp.inp.sig$$ postgp.inp.flx$$ postgp.out.pgb$$
################################################################################
