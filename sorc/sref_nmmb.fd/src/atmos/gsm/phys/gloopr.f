...
!*   &    ( grid_gr,
     &    ( grid_fld, g3d_fld,                                          &
     &     lats_nodes_r,global_lats_r, lonsperlar, phour,deltim,        &
     ...
     &     sfcvisbmu,sfcvisdfu,sfcnirbmu,sfcnirdfu,                     &
     &     sfcvisbmd,sfcvisdfd,sfcnirbmd,sfcnirdfd,                     &
...
!        write(0,*)' in gloopr lan=',lan,' lons_lat=',lons_lat,         &
!    &             ' lat=',lat
...
!  ---  inputs:
     ...
     &       NGPTC,njeff,LEVR,me, lprnt, ipt, kdt,                      &
!  ---  outputs:
