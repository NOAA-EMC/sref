...
cc
     ...
     &                       ls_dim,ls_max_node,me,nodes
      use gfs_dyn_mpi_def, only : kind_mpi,mc_comp,mpi_r_mpi
      implicit none
cc
...
cc
      ...
      subroutine sumflna_slg(flnev,flnod,lat1s,plnev,plnod,
     x                  nvars,nvars_slg,ls_node,latl2,
     x                  workdim,nvarsdim,nvarsdim_slg,four_gr,
     x                  ls_nodes,max_ls_nodes,
     x                  lats_nodes,global_lats,
