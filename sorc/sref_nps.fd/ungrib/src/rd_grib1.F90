...
!hours
  ...
  elseif (ksec1(16) == 0) then
!minutes
  call geth_newdate(hdate,hdate,60*fcst)
  elseif (ksec1(16) == 13) then
!quarter hours
  call geth_newdate(hdate,hdate,900*fcst)
  elseif (ksec1(16) == 14) then
!half hours
  call geth_newdate(hdate,hdate,1800*fcst)
  endif
