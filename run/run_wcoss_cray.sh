...
FV3HREFDIR=/gpfs/hps3/emc/meso/save/${LOGNAME}/fv3refs
cd $FV3HREFDIR/run
...
rm -rf /gpfs/hps3/ptmp/$LOGNAME/fv3href
mkdir -p /gpfs/hps3/ptmp/$LOGNAME/fv3href
rm -f *.bsub *.log
...
echo "FV3HREF waiting ${MEMBER} PREP" >> /gpfs/hps3/ptmp/$LOGNAME/fv3href/jlogfile_sref
echo "FV3HREF waiting ${MEMBER} FCST" >> /gpfs/hps3/ptmp/$LOGNAME/fv3href/jlogfile_sref
