...
!     t1=timef()
      ...
      if (me == 0) print *,'in read_sfcio nread=',nread,' cfile=',cfile
      IF (me == 0) THEN
...
!-- do not need to send data, all processores read the data
      ...
      call mpi_bcast(tmp,lonr*latr,MPI_R_IO,0,MPI_COMM_ALL,info)
...
!***********************************************************************
!
      subroutine split2d_phys_r8(x,xl,global_lats_r)
!
!***********************************************************************
!
      use resol_def,     ONLY: latr, lonr
...
!-- do not need to send data, all processores read the data
      ...
      call mpi_bcast(tmp,lonr*latr,MPI_R_IO_R,0,MPI_COMM_ALL,info)
