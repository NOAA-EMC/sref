...
C nfile - 1-21: ens mems
      parameter(mem=26,ntime=29,ncat=6,isample=20) ! 20 days
c     parameter(mem=21,ntime=29,ncat=6,isample=14) ! 14 days
c     parameter(mem=21,ntime=29,ncat=6,isample=7)  ! 7 days
...
c     parameter(jf=512*256,lon=185,lat=129,ngrid=lon*lat)
     ...
     &fcst_BC(ngrid)
      ...
      character*13  fname1
      character*15  fname2
      character*21 fcst_new1,fcst_new2,fcst_new3,fcst_new4,fcst_new5,
...
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
        write(date,'(i2.2)') (nt-1)*3+3
         ...
         fcst_new1='BC_nmb.pgrb212.c1.f' // date
         fcst_new2='BC_nmb.pgrb212.n1.f' // date
         fcst_new3='BC_nmb.pgrb212.p1.f' // date
         fcst_new4='BC_nmb.pgrb212.n2.f' // date
         fcst_new5='BC_nmb.pgrb212.p2.f' // date
         fcst_new6='BC_nmb.pgrb212.n3.f' // date
         fcst_new7='BC_nmb.pgrb212.p3.f' // date
         fcst_new8='BC_nmb.pgrb212.n4.f' // date
         fcst_new9='BC_nmb.pgrb212.p4.f' // date
        fcst_new10='BC_nmb.pgrb212.n5.f' // date
        fcst_new11='BC_nmb.pgrb212.p5.f' // date
        fcst_new12='BC_nmb.pgrb212.n6.f' // date
        fcst_new13='BC_nmb.pgrb212.p6.f' // date
        fcst_new14='BC_arw.pgrb212.c1.f' // date
        fcst_new15='BC_arw.pgrb212.n1.f' // date
        fcst_new16='BC_arw.pgrb212.p1.f' // date
        fcst_new17='BC_arw.pgrb212.n2.f' // date
        fcst_new18='BC_arw.pgrb212.p2.f' // date
        fcst_new19='BC_arw.pgrb212.n3.f' // date
        fcst_new20='BC_arw.pgrb212.p3.f' // date
        fcst_new21='BC_arw.pgrb212.n4.f' // date
        fcst_new22='BC_arw.pgrb212.p4.f' // date
        fcst_new23='BC_arw.pgrb212.n5.f' // date
        fcst_new24='BC_arw.pgrb212.p5.f' // date
        fcst_new25='BC_arw.pgrb212.n6.f' // date
        fcst_new26='BC_arw.pgrb212.p6.f' // date
...
c reduced given the fact of "normally being too dry" (except for 5 rsm members)
C Do not increase:
...
C Write out new debiased forecasts
         ...
         do i=1,25
          kpds(i)=kkpds(i)
         enddo
c        kpds(2)=113  !different models, deal with it later
c        kpds(4)=0  !bitmap
         kpds(21)=21
         kpds(22)=4
...
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
           ...
           enddo
c          if(nf.ge.1.and.nf.le.7) kpds(2)=111  !nmmb
c          if(nf.ge.8.and.nf.le.14) kpds(2)=112  !nmm
c          if(nf.ge.15.and.nf.le.21) kpds(2)=116  !arw
           if(nf.ge.1.and.nf.le.13) kpds(2)=111  !nmmb
           if(nf.ge.14.and.nf.le.26) kpds(2)=116  !arw
